...
# --- Cost Calculator & ROI ---
    ...
    # --- Core ROI Math ---
        ...
        if st.session_state.cost_roi_result:
            ...
            Loss        : {analysis['loss_percentage']:.1f}% projected
            
            FINANCIAL ANALYSIS
            Total Farm Value        : Rs {analysis['total_value']:,}
            Projected Loss          : Rs {analysis['loss_prevented']:,}
            Organic Treatment Cost  : Rs {analysis['total_organic_cost']:,}
            Chemical Treatment Cost : Rs {analysis['total_chemical_cost']:,}
            Organic ROI             : {analysis['org_roi']}%
            Chemical ROI            : {analysis['chem_roi']}%
