...
if page == "AI Plant Doctor":
    ...
    if uploaded_files and len(uploaded_files) > 0 and plant_type and plant_type != "Select a plant...":
            ...
            with st.spinner(f"Analyzing {plant_type}..."):
                try:
                    ...
                    if result:
                        ...
                        # NEW: single call to render the whole diagnosis + treatments + cost selector
                        ...
                        # Store compact summary + full result for use on other pages
        ...
        # refresh stored costs in case treatment DB changes
    ...
    if not diag:
        ...
        # keep your existing yield, market price, loss %, ROI, and comparison code below this
        with col_input3:
